...
TEMPLATE={
    ...
    'AbdomenAtlas1.0': [1,2,3,4,6,7,8,9,11]
}
...
THRESHOLD_DIC = {
    ...
    "hip_right": 0.5,
    "sacrum": 0.5,
    "gluteus_maximus_left": 0.5,
    "gluteus_maximus_right": 0.5,
    "gluteus_medius_left": 0.5,
    "gluteus_medius_right": 0.5,
    "gluteus_minimus_left": 0.5,
    "gluteus_minimus_right": 0.5,
    "autochthon_left": 0.5,
    "autochthon_right": 0.5,
    "iliopsoas_left": 0.5,
    "iliopsoas_right": 0.5
...
def get_key(name):
    ...
    dataset_index = int(name[1:5])
    if dataset_index == 10:
        template_key = name[0:2] + '_' + name[17:19]
    else:
        template_key = name[1:5]
    # print(template_key)
    return template_key
