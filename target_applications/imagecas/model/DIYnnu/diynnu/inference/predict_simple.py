...
from diynnu.inference.predict import predict_from_folder
...
def main():
    ...
    parser.add_argument("-i", '--input_folder', help="Must contain all modalities for each patient in the correct"
                                                     ...
                                                     "identifier (0000, 0001, etc)", required=False, default='xxx')
    parser.add_argument('-mp', "--model_path", required=False, help="path for model", default='xxx')
    parser.add_argument('-o', "--output_folder", required=False, help="folder for saving predictions", default='xxx')
    ...
    parser.add_argument('-f', '--folds', nargs='+', default=['0','1','2','3','4'],
    ...
    parser.add_argument("--mode", type=str, default="fast", required=False, help="Hands off!")
    ...
    model_folder_name = args.model_path
